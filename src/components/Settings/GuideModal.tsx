        ...
        >
          ...
          <GuideSection
            ...
            items={[
              ...
              'עדכוני אפליקציה: «בדוק עדכונים» בודק אם קיימת גרסה חדשה להורדה והתקנה',
              'כשנפרסם עדכון, בעת פתיחת האפליקציה עלול להופיע חלון עם קישור להורדה; ההתקנה מתבצעת מהדפדפן או מנהל הקבצים במכשיר (התקנה ידנית, כמו כל אפליקציה שלא מהחנות)',
              'בחלון העדכון אפשר לבחור «אחר כך»; אותה גרסה לא תוצג שוב עד שתפורסם גרסה חדשה יותר',
          ...
          <View style={styles.footer}>
            ...
            <Text style={styles.footerText}>
              אפשר לפתוח מחדש את המדריך בכל עת דרך «מדריך שימוש» במסך ההגדרות; באותו מסך ניתן לבדוק עדכונים, ובתחתית מופיעות זכויות היוצרים ומספר הגרסה
            </Text>
