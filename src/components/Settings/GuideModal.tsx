        ...
        >
          ...
          <GuideSection
            ...
            items={[
              ...
              '«בדוק עדכונים»: מוודא אם פורסמה גרסה חדשה; במקרה שכן, ייפתח חלון המפנה בצורה בטוחה לעמוד הגרסה הרשמי בדפדפן',
              '«התראות עדכון אוטומטיות»: בדיקת עדכונים אוטומטית בפתיחת האפליקציה או בחזרה מהרקע, והתרעה עם קישור לעמוד הגרסה כשמתפרסם עדכון (כשהמתג פעיל). כברירת מחדל המתג כבוי, ובודקים לפי הצורך ב־«בדוק עדכונים»',
              'ההורדה וההתקנה מתבצעות מהדפדפן בצורה מאובטחת ועצמאית (בלחיצה על קובץ ה-APK בדף הגרסה, מה שמונע תקיעות בהורדה)',
              'בחלון העדכון «אחר כך» משמעותו לא עכשיו — חלון אוטומטי עם אותה גרסה לא יוצג שוב עד גרסה חדשה יותר; מ«בדוק עדכונים» בהגדרות תמיד אפשר לפתוח שוב את עמוד הגרסה ולהוריד',
