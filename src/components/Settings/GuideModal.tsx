      ...
      <SafeAreaView style={styles.modalSafe} edges={['bottom']}>
        ...
        >
          ...
          <GuideSection
            ...
            title="מסך הבית"
            items={[
              'לחץ על כפתור ה-V הגדול כדי לסמן את הדף היומי כנלמד או לבטל את הסימון',
              ...
              'באנר ההתקדמות בש"ס מראה את סך כל הדפים שלמדת מתוך 2,711 דפי הש"ס',
            ]}
            theme={theme}
          />
          ...
          <GuideSection
            ...
            items={[
              'גלול בין חודשים כדי לראות את היסטוריית הלימוד שלך',
              'ימים שבהם למדת מסומנים בצבע זהב',
              'ימים שלא למדת בהם מסומנים באפור בהיר',
              'לחץ על כל תאריך כדי לראות איזה דף נלמד באותו יום',
              'המקרא בתחתית המסך מסביר את משמעות כל צבע',
            ]}
            theme={theme}
          />
          ...
          <GuideSection
            ...
            items={[
              ...
              'בהתראה עצמה יש שני כפתורים אינטראקטיביים:',
              '  • "✅ סיימתי את הדף!" - סימון הדף כנלמד ישירות מההתראה',
              '  • "⏰ תזכיר לי בעוד שעה" - דחיית התזכורת לעוד שעה',
          ...
          <View style={styles.footer}>
            ...
            <Text style={styles.footerText}>
              יש שאלות נוספות? פנה אלינו דרך מסך ההגדרות
            </Text>
