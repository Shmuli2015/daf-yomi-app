        ...
        >
          ...
          <GuideSection
            ...
            items={[
              ...
              'בכותרת המסך מופיעים הכפתורים **סמן כנלמד** / **סיימתי את הדף!** / **נלמד** לסימון הדף הנוכחי ללא צורך ביציאה מהמסך. לחיצה קצרה מסמנת דף מלא או משלימה מחצי דף; **לחיצה ארוכה** פותחת תפריט לבחירת **דף מלא**, **חצי דף (א)** או **חצי דף (ב)**. ניתן לסמן עמוד א ועמוד ב בנפרד — סימון שני העמודים (בכל סדר) משלים את הדף. בתפריט יוצג ✓ ליד העמוד שכבר נלמד. במצב חצי דף ניתן לבטל את הסימון דרך התפריט; ביטול סימון של דף מלא יבקש אישור תחילה.',
          ...
          <GuideSection
            ...
            items={[
              ...
              'לחיצה על תאריך מסוים תפתח כרטיסייה המציגה את פרטי הדף היומי, כפתורי למידה (גישה ישירה ל"ספריא" או ל"צורת הדף" בהתאם להעדפותיך), ואפשרות לסמן את הדף כנלמד או לבטל את הסימון (בכפוף לאישור). **לחיצה ארוכה** על כפתור הסימון תפתח את תפריט חצי הדף, עם אפשרות לסמן **עמוד א** או **עמוד ב** בנפרד; סימון שני העמודים משלים את הדף.',
          ...
          <GuideSection
            ...
            items={[
              ...
              'בתוך תצוגת המסכת: האפשרויות **סמן הכל** או **בטל הכל** מאפשרות עדכון מהיר של כל דפי המסכת (בכפוף לאישור). לחלופין, ניתן ללחוץ על מספר דף בודד כדי לסמנו או לבטל את סימונו. דפים שנלמדו בחלקם (חצי דף — עמוד א או ב) יוצגו בעיצוב שונה; לחיצה עליהם תשדרג את הסימון לדף מלא. לתשומת לבך: סימון ראשוני של חצי דף (עמוד א או ב) זמין רק ממסך הבית, מלוח השנה ומצורת הדף.',
