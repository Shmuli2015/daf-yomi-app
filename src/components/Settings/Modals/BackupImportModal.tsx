      ...
      <View style={styles.content}>
        ...
        <Text style={styles.hint}>
          {confirmReplace
            ...
            : '"מזג" ישלב דפי דף יומי לפי התאריך המאוחר יותר, ומסלול אישי לפי מסכת ודף, ויחזיר גם את המסכת הפעילה במסך הבית. מיזוג לא משנה שאר הגדרות (התראות, ערכת נושא וכו\'). "החלף הכל" מוחק את כל הנתונים וההגדרות הקיימים.'}
        </Text>
