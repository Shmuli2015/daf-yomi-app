...
export const GUIDE_SECTIONS: GuideSectionData[] = [
  {
    ...
    items: [
      ...
      'באנר **מסלול אישי**: מאפשר לעקוב אחר לימוד מסכתות בקצב אישי (נפרד ממחזור הדף היומי). לחיצה על הכרטיס (או על [[בחר מסכת]]) תפתח מודל לבחירת מסכת פעילה. לחיצה על [[סמן את דף...]] בבאנר תסמן מיידית את הדף הבא בתור. לחיצה על הכרטיס תפתח את רשת דפי המסכת — שבה לחיצה קצרה מסמנת דף ולחיצה ארוכה פותחת את [[צורת הדף]].',
  ...
  },
  {
    ...
    items: [
      ...
      'מקרא סימוני הדפים ברשת המסכת: דף שנלמד בשני המסלולים (גם בדף היומי וגם במסלול האישי) מעוטר ב-⭐ (כוכב מוזהב). דף שנלמד במסלול השני מסומן בנקודה עדינה.',
